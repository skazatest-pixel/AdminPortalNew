...
namespace IPNumbers
{
    // Internal class for storing a range of IP numbers
    // with the same IP mask
    internal class IPArrayList
    {
        ...
        // Checks if an IP number is within the ranges included
        // by the list
	...
	{ 
		...
		public IPList()
		{
            // Initialize IP mask list and create IPArrayList into the
            // ipRangeList
        ...
        // Adds IP numbers using a mask for range where the mask specifies
        // the number of
        // fixed bits, ex. 172.16.0.0 255.255.0.0 will add 172.16.0.0 -
        // 172.16.255.255
        ...
        // Adds IP numbers using a mask for range where the mask specifies
        // the number of
        // fixed bits, ex. 192.168.1.0/24 which will add 192.168.1.0 -
        // 192.168.1.255
        public void Add(string ipNumber, int maskLevel)
        {
            this.Add(parseIP(ipNumber),(uint)maskList.GetKey
                (maskList.IndexOfValue(maskLevel)));
        }

        // Adds IP numbers using a from and to IP number. The method checks
        // the range and
