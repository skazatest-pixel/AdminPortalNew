...
namespace DTPortal.Web.ViewModel.OnboardingFailedLogReports
{
    public class OnboardingFailedLogReportViewModel
    {
        ...
        public PaginatedList<OnboardingFailedLogReportDTO> Reports { get; set; }
    }
}
